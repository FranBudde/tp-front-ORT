...
export default function ExpenseDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-800 to-gray-900 text-white flex justify-center">
      <div className="w-full max-w-md mx-auto relative"> {/* Este es el div añadido para el formato */}
        {/* Status Bar */}
        <header className="flex justify-between items-center px-4 pt-3 pb-2 text-sm">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="bg-green-500 text-xs px-1 rounded text-black font-semibold">
              35%
            </div>
          </div>
        </header>
