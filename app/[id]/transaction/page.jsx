      ...
      <div className="w-full max-w-md mx-auto relative">
        ...
        <div className="flex mx-4 mb-6">
          <button
            ...
            className={`flex-1 py-3 text-center font-medium border-b-2 ${activeTab === 'expenses'
          ...
          <button
            ...
            className={`flex-1 py-3 text-center font-medium border-b-2 ${activeTab === 'income'
                ? 'border-white text-white'
                : 'border-transparent text-gray-400'
              }`}
          >
          ...
          <div className="grid grid-cols-4 gap-3">
            {categories.map((category) => (
              <button
                ...
                className={`flex flex-col items-center p-3 rounded-2xl transition-all hover:scale-105 ${selectedCategory === category.id
          ...
          <div className="flex gap-4">
            {dates.map((date) => (
              <button
                ...
                className={`px-4 py-3 rounded-xl text-sm whitespace-pre-line ${selectedDate === date.id
